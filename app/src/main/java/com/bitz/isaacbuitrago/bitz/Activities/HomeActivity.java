...
public class HomeActivity extends AppCompatActivity implements ItemClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        fab.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                // goto create Bit activity
                Intent intent = new Intent(HomeActivity.this, CreateBitActivity.class);
    ...
    public void onItemRowClicked(View view, int position)
    {
        ...
        Intent intent = new Intent(HomeActivity.this, ReplayBitActivity.class);
